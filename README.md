...
# Syed Abdul Mukheeth Peer

<img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=22&duration=3000&pause=800&color=00F78C&center=true&vCenter=true&width=700&lines=Full+Stack+Engineer;Distributed+Systems+%26+System+Design;Microservices+%7C+Real-Time+Architecture;Building+things+that+scale." />
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://peer-net-indol.vercel.app)
...
**Microservices · Real-Time · Production-Ready**

A high-performance Instagram-inspired social platform built with distributed architecture and a "Neon Network" design system.

**Architecture Highlights:**
- ⚙️ Decoupled REST monolith + dedicated WebSocket microservice
- ⚡ Multi-layer caching with Redis & TanStack Query
- 🔒 JWT access + refresh token rotation
- 📡 Bi-directional Socket.io event streaming
...
[![MongoDB](https://img.shields.io/badge/MongoDB-4EA94B?style=flat&logo=mongodb&logoColor=white)](https://github.com/syedmukheeth/PeerNet)
[![Redis](https://img.shields.io/badge/Redis-DC382D?style=flat&logo=redis&logoColor=white)](https://github.com/syedmukheeth/PeerNet)
...
[![API Docs](https://img.shields.io/badge/📖_API_Docs-555?style=for-the-badge)](https://peernet-5u5q.onrender.com/api-docs)
...
**Architecture Highlights:**
- 🏎️ **CRDT Collaboration** — Yjs conflict-free replicated data types for real-time multi-player editing
...
- 🌍 **Edge-First UI** — React on Vercel Edge Network for 60FPS, completely decoupled from backend
...
[![Gemini](https://img.shields.io/badge/Gemini_AI-8E75B2?style=flat&logo=google&logoColor=white)](https://github.com/syedmukheeth/SAM-Compiler)
...
**Syed Abdul Mukheeth Peer** · Full Stack · System Design · India 🇮🇳
